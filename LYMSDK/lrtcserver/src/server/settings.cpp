...
namespace lrtc
{
    ...
    bool Settings::Init(const char *confPath)
    {
        ...
        try
        {
            ...
            signaling_server_options_.host = config["signaling"]["host_ip"].as<std::string>();
            ...
            signaling_server_options_.connect_timeout = config["signaling"]["connection_timeout"].as<int>();
