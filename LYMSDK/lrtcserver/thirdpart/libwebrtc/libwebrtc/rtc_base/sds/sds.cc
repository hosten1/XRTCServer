...
#include "rtc_base/sds/sdsalloc.h"
// #include "rtc_base/sds/util.h"
#include <assert.h>
#include <string.h>
...
void *sds_malloc(size_t size) { return (char*)s_malloc(size); }
 ...
 */
sds sdstemplate(const char *template_str, sdstemplate_callback_t cb_func, void *cb_arg)
{
    sds res = sdsempty();
